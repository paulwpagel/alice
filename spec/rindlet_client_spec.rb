...
# require 'rinda/rinda_client'
# require 'rinda/tuplespace'
# require 'drb/drb'
# 
# describe "RindaClient connecting to a live server" do
#   
#   before(:each) do
...
#     @client = Core::RindaClient.new
#     Core::RindaClient.instance_variable_get("@tuplespace").should eql(nil)
#     
#     @client.write [1, 2, 3]
#     Core::RindaClient.instance_variable_get("@tuplespace").should_not eql(nil)
...
#     @client = Core::RindaClient.new
#     @client.write [1, 2, 3]
#     first_tuplespace = Core::RindaClient.instance_variable_get("@tuplespace")
#     DRb.stop_service
#     Core::RindaClient.close
#     
#     @client.write [3, 2, 1]
#     DRb.current_server.should_not be(nil)
#     Core::RindaClient.instance_variable_get("@tuplespace").should_not be(first_tuplespace)
#   end
#   
...
#     Core::RindaClient.should_receive(:tuplespace).and_return(mock_tuplespace)
